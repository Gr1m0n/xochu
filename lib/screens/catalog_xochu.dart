...
class CatalogXochu extends StatefulWidget {
  @override
  _CatalogXochuState createState() => _CatalogXochuState();
}
class _CatalogXochuState extends State<CatalogXochu> {
  ...
  void initState() {
    fetchPage = Provider.of<PageProvider>(context, listen: false)
        .getPage(id: 4, lang: translator.activeLanguageCode);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBarWidget(title: 'Хочу купить'),
      ),
